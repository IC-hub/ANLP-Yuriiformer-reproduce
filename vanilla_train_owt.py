"""DDP training script for vanilla nanoGPT-style Transformer on OpenWebText."""
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_vanilla_owt")
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="vanilla-transformer-owt", config=config, resume="allow")
