"""DDP training script for Adam+Lie-Trotter AdamFormer on OpenWebText (multi-GPU).
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_adam_owt")
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="adamformer-owt", config=config, resume="allow")
