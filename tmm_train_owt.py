"""DDP training script for TMM+Lie-Trotter TMMFormer on OpenWebText (multi-GPU)."""
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_tmm_owt")
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="tmmformer-owt", config=config, resume="allow")
