"""DDP training of YuriiFormer on OWT with sharpness-aware interventions.
...
def main():
    ...
    ckpt_dir = os.path.join(CACHE, f"checkpoints_yurii_{args.mode}_owt")
    ...
    if rank == 0:
        ...
        wandb.init(project="yuriiformer-owt-flat",
