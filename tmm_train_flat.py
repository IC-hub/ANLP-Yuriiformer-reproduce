"""DDP training of TMMFormer on TinyStories with sharpness-aware interventions.
...
def main():
    ...
    ckpt_dir = os.path.join(CACHE, f"checkpoints_tmm_{args.mode}_ts")
    ...
    if rank == 0:
        config = {
            "model": "TMMFormer-small-TinyStories",
            "mode": args.mode,
            "rho": args.rho,
        ...
        wandb.init(project="tmmformer-ts-flat",
