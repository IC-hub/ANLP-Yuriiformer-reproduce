"""DDP training script for TMM+Lie-Trotter YuriiFormer on OpenWebText (multi-GPU)."""
...
CKPT_DIR = os.path.join(CACHE, "checkpoints_yurii_owt")
...
def main():
    ...
    if rank == 0:
        ...
        wandb.init(project="yuriiformer-owt", config=config, resume="allow")
